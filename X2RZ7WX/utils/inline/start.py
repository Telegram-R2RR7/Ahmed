    ...
    if GITHUB_REPO and OWNER:
        ...
        if OWNER:
            buttons.append(
                [
                    InlineKeyboardButton(
                        text=_["S_B_11"], url=f"https://t.me/R2RR7"
                    ),
                    InlineKeyboardButton(

                        text=_["S_B_12"], url=f"https://t.me/R2RR7"
            ...
            buttons.append(
                [
                    ...
                    InlineKeyboardButton(
                        ...
                        text=_["S_B_10"], url=f"https://t.me/R2RR7"
...
- لو واجهت مشكله او ما فهمت خطوة كلم مطور البوت ~ @R2RR7""",
...
مطور السورس -› [Khaled](t.me/R2RR7)
قناة السورس -› [𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒓𝒂](t.me/R2RR7)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
